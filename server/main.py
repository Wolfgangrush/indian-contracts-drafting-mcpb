"""Wolfgang Rush — Indian Contracts & Personal-Estate Drafting MCPB.

Local-execution.

License: MIT
Source: https://github.com/Wolfgangrush/indian-contracts-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-contracts-drafting")

BUNDLE_ROOT = Path(__file__).resolve().parent.parent
SKILLS_DIR = BUNDLE_ROOT / "skills"
AGENTS_DIR = BUNDLE_ROOT / "agents"
PLEADING_BASE_DIR = SKILLS_DIR / "_contract_drafting_base"
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN CONTRACT DRAFTING AND DISPUTE FORUMS DRAFTING · FULL ORCHESTRATION SCRIPT
...
commercial-service-agreement, nda, employment-agreement, lease-deed, sale-deed, gpa-spa, shareholders-agreement, will, loan-agreement, arbitration-clause.
...
def get_pleading_base() -> str:
    """Get the shared contracts drafting base structure."""
